...
[¿Qué es Coerción en JavaScript?](#¿-qué-es-coerción-en-javascript)

[¿Qué es el operador typeof?](#¿-qué-es-el-operador-typeof)
...
### ¿ Qué es Coerción en JavaScript ?

En la conversión de Javascript existen dos diferentes tipos de integraciones llamado `coerción`. La Coerción trae dos diferentes formas en Javascript: *explícita* e *implícita*.  
...
b;				// 42 -- número!
```
Y un ejemplo de Coerción implícita:
```js
var a = "42";

var b = a * 1;	// "42" Implícitamente coercionado a 42
...
[[↑] Vuelta a la cabecera](#JavaScript)
### ¿ Qué es el operador typeof ?


Javascript proporciona un operador `typeof` que puede examinar un valor y decirte de que tipo es:
```js
var a;
typeof a;				// "undefined"
